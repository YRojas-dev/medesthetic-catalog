document.addEventListener('DOMContentLoaded', () => {
    ...
    const logoLight = isIndexPage ? "img/logo-light.png" : "../img/logo-light.png";
    const logoDark = isIndexPage ? "img/logo-dark.png" : "../img/logo-dark.png";
    ...
    document.getElementById("nav-container").innerHTML = `
        <nav id="main-nav">
            <div class="nav-content">
                <a id="top-nav" href="${isIndexPage ? "" : "../"}index.html#">Inicio</a>
                <a id="treatments-nav" href="${isIndexPage ? "" : "../"}index.html#treatments-section">Tratamientos</a>
                <a id="contact-nav" href="${isIndexPage ? "" : "../"}index.html#contact-section">Contacto</a>
                <a id="location-nav" href="${isIndexPage ? "" : "../"}index.html#location-section">Ubicación</a>
            </div>
        </nav>
    `;
    ...
    document.getElementById("footer-container").innerHTML = `
        <footer class="main-footer">
            <img src="${logoLight}" alt="Logo" class="footer-logo" />
    ...
    if (!window.location.pathname.includes("privacy-view.html")) {
        const privacyContainer = document.getElementById("privacy-link-container");
        privacyContainer.innerHTML = `<a class="privacy" href="${isIndexPage ? "pages" : ".."}/privacy-view.html">Aviso de Privacidad</a>`;
    }

    if (!window.location.pathname.includes("index.html")) {
        const privacyContainer = document.getElementById("privacy-link-container");
        privacyContainer.innerHTML = `<a class="privacy" href="privacy-view.html">Aviso de Privacidad</a>`;
    }
